...
FAST_CONFIGS: dict[str, dict[str, object]] = {
    "A_SingleTree": {
        "n_estimators": 1,
        "use_bootstrap": False,
        "use_feature_subsampling": False,
            ...
            for seed_idx, seed in enumerate(active_seeds, start=1):
                ...
                if verbose:
                    ...
                    print(
                        ...
                        f"r2={results_per_seed[-1]['r2']:.4f} "
                        f"rmse={results_per_seed[-1]['rmse']:.4f} "
                        f"train={results_per_seed[-1]['train_time']:.2f}s "
